...
import com.example.crypto_app.databinding.RvItemBinding

class Rv_Adapter(val context: Context, var data: ArrayList<Modal>) :
    ...
    fun setAnimation(view: View) {
        val scroll = AlphaAnimation(0.0f, 1.0f)
        scroll.duration = 1000
        view.startAnimation(scroll)
    }
}